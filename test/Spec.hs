...
main = hspec $ do
    ...
    describe "Sort tasks" $ do
        ...
        it "sort on several keys" $ do
            sortTasks [T.title] tasks `shouldBe` [t4,t1,t3,t2]
            sortTasks [ (M.title . T.milestone)
                      , T.title
